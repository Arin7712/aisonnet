  ...
  return (
    <div>
      ...
      <div className="block md:hidden">
        <section className="flex z-50 items-center border-b-[1px] border-gray-100 p-4 w-full justify-between">
          <div>
            <h2 className="text-md font-bold">AI Sonnet.</h2>
          </div>
      ...
      <button className="rounded-2xl bg-[#9c6ef7] px-4 py-2 text-sm text-white font-medium">
          ...
          >
            <div className="bg-[#fafafa] flex flex-col items-start gap-4 p-3 z-50">
            ...
            <div className="flex bg-white flex-col p-3 mt-6">
              <div className="z-50 ">
